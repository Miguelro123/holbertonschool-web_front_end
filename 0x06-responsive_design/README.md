...
![Wifeframe](wireframe.png "Wifeframe")
...
Or some basics assets from this [archive.zip](https://intranet.hbtn.io/rltoken/6BplmML9ykn1Aam4aYXHIA)
...
Whatever the browser you use, it’s a good idea from now on, to [toggle the device view](https://developers.google.com/web/tools/chrome-devtools/device-mode).
...
![Rendering4](rendering4.png "Rendering4")
...
![Rendering5](rendering5.png "Rendering5")
